...
_IP6_ADDRMODE = _descriptor.EnumDescriptor(
  name='AddrMode',
...
_sym_db.RegisterEnumDescriptor(_IP6_ADDRMODE)


_IP6 = _descriptor.Descriptor(
  name='Ip6',
...
Ip6 = _reflection.GeneratedProtocolMessageType('Ip6', (_message.Message,), dict(
  DESCRIPTOR = _IP6,
  __module__ = 'ip6_pb2'
  # @@protoc_insertion_point(class_scope:OstProto.Ip6)
  ))
_sym_db.RegisterMessage(Ip6)
